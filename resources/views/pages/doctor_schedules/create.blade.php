                    ...
                    <form action="{{ route('doctor-schedules.store') }}"method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Doctor</label>
                                <select class="form-control selectric @error('doctor_id') is-valid @enderror"
                                    name='doctor_id'>
                                    <option value="">Select Doctor</option>
                                    @foreach ($doctors as $doctor )
                                    {{-- yang diambil doctor id dan yang dimunculkan adalah doctor namanya --}}
                            ...
                            {{-- <div class="form-group mt-3">
                                ...
                                <div class="form-check mb-3">
                                    <input class="form-check @error('status') is-invalid
                                    @enderror" type="radio"
                                    name="status" id="active" value="active" checked>
                                    <label class="form-check form-check-inline" for="active">Active</label>
                                </div>
                                <div class="form-check mb-3">
                                    <input class="form-check @error('status') is-invalid
                                    @enderror" type="radio"
                                    name="status" id="inactive" value="inactive" checked>
                                    <label class="form-check form-check-inline" for="inactive">Inactive</label>
                                </div>
                            </div> --}}
